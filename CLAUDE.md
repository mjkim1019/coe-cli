...
8. **[P1] MCP (Multi-step Code Planning)**: LLM이 복잡한 요청을 단계별로 분해하여 실행 + SSE 실시간 스트리밍 - 개발 예정
9. **[P1] 프롬프트 캐싱**: OpenAI 프롬프트 캐싱을 통한 성능 최적화 - 개발 예정
10. **[P2] 파일 감시**: 파일 시스템 변경 감지 및 자동 재분석 (Hot Reload) - 개발 예정
11. **[P2] Edit GuardRail**: 파일 변경 이력 추적 및 LLM 생성 변경 이유 주석 - 개발 예정
12. **[P2] 세션 이어서 하기**: 이전 작업 컨텍스트를 저장하고 복원하는 세션 연속성 기능 - 개발 예정
13. **[P3] 자동 테스트**: 파일 저장/수정 시 자동 테스트 실행 (Makefile, CMake 지원) - 개발 예정
14. **[P3] 세션 관리**: 세션 저장/복구, LLM 기반 자동 컨텍스트 구성 - 개발 예정
15. **[P3] 정교한 diff/patch**: 변경사항 분석, 패치 적용, 롤백, 자동 백업 - 개발 예정
16. **[P3] 권한 프롬프트**: LLM 호출, 실행 작업 등 사전 확인 시스템 - 개발 예정
17. **[P4] 템플릿 파일 생성**: 미리 정의된 템플릿을 바탕으로 새로운 파일을 생성하는 기능 - 개발 예정
18. **[P4] 공통 MD 파일 생성**: 프로젝트 전반에서 참조할 마크다운 문서를 자동 생성하는 기능 - 개발 예정
